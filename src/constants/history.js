...
export const historyTimeline = [
  ...
  },
  {
    question: "2001 год",
    answer:
      "Начался импорт мороженого из  России и Казахстана. Компания сотрудничала с такими производителями, как «Inmarko”, “Шин-лайн» «Альтервест», а также начала завозить в Узбекистан различные компоненты для мороженого - стабилизаторы , сырье и другие ингредиенты.",
  },
  {
    question: "2002 год",
    answer:
