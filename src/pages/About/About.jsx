  ...
  return (
    <div className="container">
      ...
      <section className="history">
        ...
        <h2 className="history-title">История ко</h2>
        </div>
